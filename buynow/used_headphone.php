...
<html>
<head>
  <title>PreOwned Headphone</title>
  <meta charset="UTF-8">
...
<body>
  <div class="ui text container" style ="text-align: center; background-color: #1eaef4; padding: 2% ">
    <h1> Trust to buy your Pre-Owned Headphone</h1>
  ...
  <button class="ui white huge button" onclick=toggle_searchbar()> Search </button>
    ...
    <form class="ui form" method="get" action="used_headphone_searchresult.php">
      <div class="field">
        <label>Brand Name</label>
        <input type="text" name="keyword" placeholder="Partial Headphone Brand Name">
      </div>
...
<?php
    ...
    $query = "SELECT * FROM `headphone` WHERE HP_CATAGORY =0";
