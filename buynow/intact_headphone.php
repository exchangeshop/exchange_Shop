...
<body>
  <div class="ui text container" style ="text-align: center; background-color: #1eaef4; padding: 1% ">
    <h1> Enjoy to buy your Headphone</h1>
  ...
  <div id="searchbar" style="display: none; text-align: left;">
    <form class="ui form" method="get" action="intact_headphone_searchresult.php">
      <div class="field">
...
<?php
    ...
    $query = "SELECT * FROM `headphone` WHERE HP_CATAGORY =1";
