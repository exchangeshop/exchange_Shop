...
<html>
<head>
  <title>Intact Graphics Card</title>
  <meta charset="UTF-8">
...
<body>
  <div class="ui text container" style ="text-align: center; background-color: #1eaef4; padding: 1% ">
    <h1> Enjoy to buy your Graphics Card</h1>
  ...
  <div id="searchbar" style="display: none; text-align: left;">
    <form class="ui form" method="get" action="intact_graphicscard_searchresult.php">
      <div class="field">
...
<?php
    ...
    $query = "SELECT * FROM `graphics_card` WHERE GPU_CATAGORY =1";
