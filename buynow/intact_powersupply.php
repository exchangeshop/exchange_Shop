...
<html>
<head>
  <title>Intact Power Supply</title>
  <meta charset="UTF-8">
...
<body>
  <div class="ui text container" style ="text-align: center; background-color: #1eaef4; padding: 1% ">
    <h1> Enjoy to buy your Power Supply</h1>
  ...
  <div id="searchbar" style="display: none; text-align: left;">
    <form class="ui form" method="get" action="intact_powersupply_searchresult.php">
      <div class="field">
        <label>Brand Name</label>
        <input type="text" name="keyword" placeholder="Partial Powersupply Brand Name">
      </div>
...
<?php
    ...
    $query = "SELECT * FROM `power_supply` WHERE PS_CATAGORY =1";
