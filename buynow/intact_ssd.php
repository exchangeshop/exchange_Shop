...
<body>
  ...
  <div id="searchbar" style="display: none; text-align: left;">
    <form class="ui form" method="get" action="intact_ssd_searchresult.php">
      <div class="field">
...
<?php
    ...
    $query = "SELECT * FROM `ssd` WHERE SSD_CATAGORY =1";
