...
<body>
  <div class="ui text container" style ="text-align: center; background-color: #1eaef4; padding: 1% ">
    <h1> Enjoy to buy your HARDISK</h1>
  ...
  <div id="searchbar" style="display: none; text-align: left;">
    <form class="ui form" method="get" action="intact_hdd_searchresult.php">
      <div class="field">
...
<?php
    ...
    $query = "SELECT * FROM `hdd` WHERE HDD_CATAGORY = 1";
