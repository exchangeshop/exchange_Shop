...
<body>
  <div class="ui text container" style ="text-align: center; background-color: #1eaef4; padding: 2% ">
     <h1> Trust to buy your Pre-Owned Monitor</h1>
  ...
  <div id="searchbar" style="display: none; text-align: left;">
    <form class="ui form" method="get" action="used_monitor_searchresult.php">
      <div class="field">
...
<?php
    ...
    $query = "SELECT * FROM `monitor` WHERE MONITOR_CATAGORY = 0";
